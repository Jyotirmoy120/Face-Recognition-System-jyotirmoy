...
class Register:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(file=r"C:\Users\rajar\Documents\Python_Test_Projects\Images_GUI\bgReg.jpg")
        ...
        registerbtn.place(x=103, y=510, width=270, height=35)

        # Creating Button Login
        loginbtn = Button(frame, command=self.open_login_window, text="Login", font=("times new roman", 15, "bold"), bd=0, relief=RIDGE, fg="#fff", bg="#002B53", activeforeground="white", activebackground="#007ACC")
    ...
    def open_login_window(self):
        from login import Login  # Importing Login here to avoid circular import
