...
# This part is image labels setting start 
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\rajar\Documents\Python_Test_Projects\Images_GUI\bg4.png")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Website_Project\Python_Test_Projects\Images_GUI\linkedin.png")
        ...
        det_img_btn=Image.open(r"C:\Users\rajar\Documents\Python_Test_Projects\Images_GUI\fb.png")
        ...
        att_img_btn=Image.open(r"C:\Website_Project\Python_Test_Projects\Images_GUI\github.jpg")
        ...
        att_b1_1 = Button(bg_img,command=self.youtube,text="GitHub",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        att_b1_1.place(x=710,y=380,width=180,height=45)

         # Help  Support  button 4
        hlp_img_btn=Image.open(r"C:\Users\rajar\Documents\Python_Test_Projects\Images_GUI\gmail.png")
    ...
    def website(self):
        self.new = 1
        self.url = "https://www.linkedin.com/in/jyotirmoy-adhikary-a15211242/"
        webbrowser.open(self.url,new=self.new)
    
    def facebook(self):
        self.new = 1
        self.url = "https://www.facebook.com/jyotirmoy.adhikary.50"
        webbrowser.open(self.url,new=self.new)
    
    def youtube(self):
        self.new = 1
        self.url = "https://github.com/Jyotirmoy120"
        webbrowser.open(self.url,new=self.new)
    
    def gmail(self):
        self.new = 1
        self.url = "jyotirmoyofficial00@gmail.com"
        webbrowser.open(self.url,new=self.new)
